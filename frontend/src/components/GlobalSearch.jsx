    ...
    try {
      ...
      const mockResults = [
        // Courses
        {
          ...
          description: 'Complete introduction to the European AI Act regulations',
          icon: BookOpen,
          url: '/courses/1',
          meta: '12 modules • 4 hours',
          relevance: query.toLowerCase().includes('ai') ? 100 : 80
        },
        {
          id: 'course-2',
          type: 'course',
          title: 'Risk Assessment for AI Systems',
          description: 'Learn to identify and mitigate risks in AI implementations',
          icon: BookOpen,
          url: '/courses/2',
          meta: '15 modules • 6 hours',
          relevance: query.toLowerCase().includes('risk') ? 100 : 70
        },
        // Lessons
        {
          id: 'lesson-1',
          ...
          description: 'Lesson 1 in EU AI Act Fundamentals',
          icon: FileText,
          url: '/course/1/lesson/1',
          meta: 'Video • 15 min',
          relevance: 60
        },
        {
          ...
          description: 'Lesson 3 in Risk Assessment course',
          icon: FileText,
          url: '/course/2/lesson/3',
        ...
        ...(user?.role !== 'participant' ? [
          {
            ...
            type: 'user',
            title: 'John Doe',
            description: 'john.doe@company.com • Engineering Team',
            icon: Users,
            url: '/team/user/1',
            meta: 'Active • 85% progress',
            relevance: query.toLowerCase().includes('john') ? 100 : 30
          },
          {
            id: 'user-2',
            type: 'user',
            title: 'Sarah Johnson',
            description: 'sarah.j@company.com • Product Team',
            icon: Users,
            url: '/team/user/2',
            meta: 'Active • 92% progress',
            relevance: query.toLowerCase().includes('sarah') ? 100 : 30
          }
        ] : []),
        // Certificates
        {
          ...
          description: 'Earned on August 15, 2024',
          icon: Award,
          url: '/certificates/1',
          meta: 'Valid until 2026',
          relevance: query.toLowerCase().includes('certificate') ? 100 : 40
        },
        ...
        ...(user?.role !== 'participant' ? [
          {
            ...
            description: 'Team compliance status for Q3 2024',
            icon: TrendingUp,
            url: '/reports/compliance',
            meta: 'Generated weekly',
            relevance: query.toLowerCase().includes('report') ? 100 : 20
          }
        ] : [])
      ];
