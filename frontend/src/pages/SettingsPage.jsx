  ...
  const loadUserSettings = async () => {
    try {
      ...
      if (notificationResponse.preferences) {
        setNotifications({
          emailNotifications: notificationResponse.preferences.email_notifications !== false,
          courseReminders: notificationResponse.preferences.course_reminders !== false,
          certificateAlerts: notificationResponse.preferences.certificate_alerts !== false,
        ...
        <div className="bg-gradient-to-r from-gray-600 to-gray-800 rounded-xl p-6 text-white">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex items-center gap-4">
              <Avatar className="w-16 h-16 bg-white text-gray-800 text-xl font-bold">
                {getInitials()}
              </Avatar>
              <div>
            ...
            <div className="flex items-center gap-4">
              ...
              <Settings className="w-12 h-12 text-gray-300 hidden lg:block" />
            </div>
          </div>
        </div>
            ...
            <Card className="bg-white dark:bg-gray-800 border-0 shadow-sm">
              ...
              <CardContent>
                <form onSubmit={handleProfileUpdate} className="space-y-6">
                  {/* Profile Photo */}
                  <div className="flex items-center gap-4">
                    <Avatar className="w-20 h-20 bg-gradient-to-br from-blue-500 to-purple-600 text-white text-2xl font-bold">
                      {getInitials()}
                    </Avatar>
                    <div>
            ...
            <Card className="bg-white dark:bg-gray-800 border-0 shadow-sm">
              ...
              <CardContent className="space-y-4">
                {Object.entries({
                  ...
                  courseReminders: { label: 'Course Reminders', description: 'Reminders for upcoming lessons and deadlines' },
                  certificateAlerts: { label: 'Certificate Alerts', description: 'Notifications when you earn certificates' },
                  teamUpdates: { label: 'Team Updates', description: 'Updates about your team\'s progress' },
                  marketing: { label: 'Marketing Communications', description: 'Product updates and promotional content' }
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Automatically save your progress as you learn</p>
                    </div>
                    <Button
                      variant={preferences.autoSave ? "default" : "outline"}
                      size="sm"
                      onClick={() => handlePreferenceUpdate('autoSave', !preferences.autoSave)}
                    >
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Use a more compact layout for better information density</p>
                    </div>
                    <Button
                      variant={preferences.compactView ? "default" : "outline"}
                      size="sm"
                      onClick={() => handlePreferenceUpdate('compactView', !preferences.compactView)}
                    >
